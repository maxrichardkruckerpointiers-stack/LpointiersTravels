...
export const TRANSLATIONS = {
  en: {
    ...
    planner: {
      ...
      labelVibe: 'Vibe & Entertainment',
      labelBudget: 'Budget Level',
      btnGenerate: 'Generate My Plan',
      btnLoading: 'Crafting Experience...',
  ...
  es: {
    ...
    company: {
      ...
      missionText: "Otorgar una experiencia única e inolvidable para cada usuario, conectándolos con la magia de Cartagena a través de un servicio de alta calidad, precios competitivos y un profundo respeto por nuestra cultura.",
    ...
    planner: {
      ...
      labelVibe: 'Vibra y Entretenimiento',
      labelBudget: 'Presupuesto',
      btnGenerate: 'Generar Mi Plan',
      btnLoading: 'Creando Experiencia...',
      bookPlan: 'Reservar Este Plan'
    },
    banner: {
