...
const Testimonials: React.FC = () => {
  return (
    <section id="reviews" className="py-20 bg-emerald-950 text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-orange-500 rounded-full blur-3xl opacity-10 transform -translate-x-1/3 translate-y-1/3"></div>
            ...
            <div key={t.id} className="bg-white/10 backdrop-blur-md border border-white/10 p-8 rounded-2xl relative">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="ml-auto">
                   ...
                   <span className={`text-xs font-bold px-2 py-1 rounded ${t.platform === 'TripAdvisor' ? 'bg-green-500 text-white' : 'bg-blue-500 text-white'}`}>
                     {t.platform}
                   </span>
                </div>
              </div>
